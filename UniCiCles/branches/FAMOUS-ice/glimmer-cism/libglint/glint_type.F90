...
!       Maybe we should create a new derived type (glint_instance_gcm?) without the extra information.
  ...
  integer, parameter :: iglint_global = 43     ! SW Greenland point on 64 x 32 glint_example global grid
  integer, parameter :: jglint_global = 5      ! j increases from north to south
